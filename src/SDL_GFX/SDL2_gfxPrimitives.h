...
SDL2_GFXPRIMITIVES_SCOPE int filledRectangleColor(SDL_Renderer * renderer, Sint16 x1, Sint16 y1, Sint16 x2, Sint16 y2, Uint32 color);
SDL2_GFXPRIMITIVES_SCOPE int filledRectangleRGBA(SDL_Renderer * renderer, Sint16 x1, Sint16 y1,
        Sint16 x2, Sint16 y2, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
...
SDL2_GFXPRIMITIVES_SCOPE int filledCircleRGBA(SDL_Renderer * renderer, Sint16 x, Sint16 y,
        Sint16 rad, Uint8 r, Uint8 g, Uint8 b, Uint8 a);
SDL2_GFXPRIMITIVES_SCOPE int texturedCircle(SDL_Renderer * renderer, Sint16 x, Sint16 y,
        Sint16 rad,SDL_Texture * texture,int texture_dx,int texture_dy);
...
SDL2_GFXPRIMITIVES_SCOPE int texturedPolygonSur(SDL_Surface * dst, const Sint16 * vx, const Sint16 * vy, int n, SDL_Surface * texture,int texture_dx,int texture_dy);
SDL2_GFXPRIMITIVES_SCOPE int texturedPolygonTex(SDL_Renderer * dst, const Sint16 * vx, const Sint16 * vy, int n, SDL_Texture * texture,int texture_dx,int texture_dy);
