...
void bind_graphics(){
	...
	.addConstant("bgr",(int)GPU_FORMAT_BGR)
	.addConstant("bgra",(int)GPU_FORMAT_BGRA)
	.addConstant("abgr",(int)GPU_FORMAT_ABGR)
	.endNamespace()
	...
	.addConstant("never",(int)GPU_NEVER)
	.addConstant("less",(int)GPU_LESS)
	.addConstant("greater",(int)GPU_GREATER)
	.addConstant("equal",(int)GPU_EQUAL)
	.addConstant("notequal",(int)GPU_NOTEQUAL)
	.addConstant("lequal",(int)GPU_LEQUAL)
	.addConstant("gequal",(int)GPU_GEQUAL)
	.addConstant("always",(int)GPU_ALWAYS)
	.endNamespace()
	.endNamespace();
}
